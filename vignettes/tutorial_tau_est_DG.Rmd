...
Let $\Phi_2(x,K_V)$ be the cumulative distribution function of a multivariate normal distribution ($\mu_{V_i}=0$, $\sigma_{V_i}$ for all components $i$) with covariance $K$, evaluated at $x$ for all components: 
