...
class neuron {
  ...
  public:
    ...
    void load_spike_raster(const MatrixXd& sr, const int& fallback_duration, const int& fallback_displacement);
    void load_spike_raster_R(const NumericMatrix& sr, const int& fallback_duration, const int& fallback_displacement);
    void infer_raster();
    void infer_trial(const int& fallback_duration, const int& fallback_displacement);
